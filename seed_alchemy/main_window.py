...
class MainWindow(QMainWindow):
    def __init__(self, settings: QSettings, collections: list[str]):
        ...
        self.image_mode_widget = ImageModeWidget(self)
        self.prompt_mode_widget = PromptModeWidget(self)

        # Stacked Layout
        self.stacked_layout = QStackedLayout()
        self.stacked_layout.addWidget(self.image_mode_widget)
        self.stacked_layout.addWidget(self.prompt_mode_widget)
    ...
    def set_mode(self, mode):
        ...
        if mode == "image":
            ...
            current_widget = self.image_mode_widget
        elif mode == "prompt":
            self.button_group.button(1).setChecked(True)
            current_widget = self.prompt_mode_widget

        self.stacked_layout.setCurrentWidget(current_widget)
