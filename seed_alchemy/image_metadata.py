...
class ImageMetadata:
    ...
    def load_from_settings(self, settings):
        ...
        if self.control_net_enabled:
            ...
            self.control_nets = [
                ControlNetMetadata.from_dict(item) for item in json.loads(settings.value("control_nets"))
            ]
        ...
        if "sd-metadata" in image_info:
            ...
            if "image" in sd_metadata:
                ...
                if self.control_net_enabled:
                    ...
                    self.control_nets = [
                        ControlNetMetadata.from_dict(item) for item in image_data.get("control_nets", "[]")
                    ]
